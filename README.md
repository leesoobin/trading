...
| 전략 | 손절 | 익절/청산 조건 | 최대 보유 |
|------|------|--------------|----------|
| MTF | LTF 스윙 저점 | HTF 스윙 고점 | **3일** |
| 볼린저밴드 | -3% | 볼린저 중심선(MA20) 도달 | **3일** |
| 추세추종 | -3% | MA20 < MA200 데드크로스 | **14일** |
| 이평선 눌림목 | -3% | EMA 역배열 | **14일** |
| 터틀 | -3% | 10일/20일 최저가 이탈 | **제한 없음** |
...
- [x] 최대 보유 기간 강제 청산 (볼린저/MTF 3일, 추세추종 14일, 터틀 제외)
